            ...
            <View style={styles.innerCard}>
                <Pressable style={styles.shopContainer} onPress={() => {
                    ...
                    <View style={styles.shopContainer}>
                        ...
                        <TextComponent
                            text={item.raisonSociale ?item.raisonSociale :item.shop.raisonSociale}
                    ...
                    <Pressable style={[Style.rowDirection]}
                            onPress={() => {
                                item.tel !=null ? (
                                 Linking.openURL(`tel:${(item.tel).split(" ").join("")}`)
                                 ):null
                                }}>
                        ...
                        <View style={styles.priceContainer}>
                            ...
                            />
                            <TextComponent
                                text={item.price ? Number(item.price).toFixed(2) + "DT/Kg" : '0DT/Kg'}
